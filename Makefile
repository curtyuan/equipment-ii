...
.PHONY: all build package package-linux-amd64 package-linux-arm64 package-arch fmt-check vet test test-go test-contract test-ordinary-set-tmux test-payload-render-shared test-payload-routing test-combo-launch test-entry-tmux test-variables-tmux test-variable-output-tmux test-variable-mutations-tmux test-set-tmux test-unset-all-tmux test-load-all-tmux test-get-tmux test-clipboard-tmux test-tmux-install test-tmux-popup test-tmux-popup-interactive test-tmux-status test-payload-input-usage-tmux test-legacy test-legacy-tmux cross-build clean
...
package: build
	...
	cp lib/ordinary_runtime.zsh lib/ordinary_variables.zsh lib/ordinary_read.zsh lib/ordinary_clipboard.zsh lib/ordinary_get.zsh lib/ordinary_interactive.zsh lib/ordinary_payload_render.zsh lib/ordinary_payload.zsh lib/ordinary_tmux.zsh lib/ordinary_help.zsh $(EXPORT_DIR)/lib/
...
package-arch:
	...
	cp lib/ordinary_runtime.zsh lib/ordinary_variables.zsh lib/ordinary_read.zsh lib/ordinary_clipboard.zsh lib/ordinary_get.zsh lib/ordinary_interactive.zsh lib/ordinary_payload_render.zsh lib/ordinary_payload.zsh lib/ordinary_tmux.zsh lib/ordinary_help.zsh export/linux-$(ARCH)/ii/lib/
...
test: fmt-check vet test-go test-payload-render-shared test-payload-routing test-combo-launch test-contract
