...
package: build
	...
	cp lib/ordinary_runtime.zsh lib/ordinary_variables.zsh lib/ordinary_read.zsh lib/ordinary_clipboard.zsh lib/ordinary_get.zsh $(EXPORT_DIR)/lib/
...
package-arch:
	...
	cp lib/ordinary_runtime.zsh lib/ordinary_variables.zsh lib/ordinary_read.zsh lib/ordinary_clipboard.zsh lib/ordinary_get.zsh export/linux-$(ARCH)/ii/lib/
