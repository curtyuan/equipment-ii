...
remaining workflow boundary is ordered stage confirmation/dispatch and public
payload routing; spatial lane selection, tmux discovery, memory, identity
validation, and literal transport are Go-owned.
