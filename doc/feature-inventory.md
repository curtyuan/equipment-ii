...
| `/www` publication and browsing | Hybrid | Go owns `ls`, `search`, and `ln`; legacy owns `--file` and child help | Complete render-and-link output, help migration, and semantic contracts. |
...
- Complete `/www --file`, child help, and semantic differential contracts.
